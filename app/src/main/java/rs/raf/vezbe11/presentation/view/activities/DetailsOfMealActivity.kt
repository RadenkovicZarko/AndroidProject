...
import rs.raf.vezbe11.presentation.view.fragments.DetailsOfMealsFragment
...
class DetailsOfMealActivity : AppCompatActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fragment = DetailsOfMealsFragment(str) // Instantiate your fragment class
